...
class Step2PrivacyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const selected = _PrivacyType.link; // пока константа: выбрано «По ссылке»
              ...
              child: Column(
                ...
                children: [
                  ...
                  _PrivacyCard(
                    ...
                    selected: selected == _PrivacyType.private,
                  ),
                  ...
                  _PrivacyCard(
                    ...
                    icon: Icons.link,
                    selected: selected == _PrivacyType.link,
                  ),
                  const SizedBox(height: 12),
                  _PrivacyCard(
                    title: 'Публичная',
                    ...
                    icon: Icons.public,
                    selected: selected == _PrivacyType.public,
                  ),
                ],
              ),
            ),
